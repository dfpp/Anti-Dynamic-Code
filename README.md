...
<p align="center">
  <img src="./反调试.png" width="70%">
</p>

*注：如果项目中的图片无法加载，请尝试使用VPN或更换加速节点。*
...
## 反Hook技术
安卓反Hook技术是一种用于检测和防御应用程序被动态分析或修改的技术，通过监测和限制对应用运行时环境的篡改来保护应用的完整性和安全性。下图展示了基本的反Hook技术利用流程及其可选方案。

<p align="center">
  <img src="./反Hook.png" width="70%">
</p>
